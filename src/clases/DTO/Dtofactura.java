...
public class Dtofactura {
    ...
    String codigofactura, nombreC, apellidoC, tipofactura, referenciaP;
    int cantidad, precio;
    ...
    public Dtofactura(String codigofactura, String nombreC, String apellidoC, String tipofactura, String referenciaP, int cantidad, int precio, float itebis, float balance) {
